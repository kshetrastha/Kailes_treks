...
public sealed class WhyWithUsService(AppDbContext dbContext) : GenericRepository<WhyWithUs>(dbContext), IWhyWithUsService
{
    public async Task<IReadOnlyList<WhyWithUs>> ListOrderedAsync(bool publishedOnly, CancellationToken ct)
    {
