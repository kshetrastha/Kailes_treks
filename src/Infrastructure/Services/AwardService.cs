...
public sealed class AwardService(AppDbContext dbContext) : GenericRepository<Award>(dbContext), IAwardService
{
    public async Task<IReadOnlyList<Award>> ListOrderedAsync(bool publishedOnly, CancellationToken ct)
    {
