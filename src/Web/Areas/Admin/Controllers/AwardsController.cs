...
public sealed class AwardsController(IUnitOfWork uow, IWebHostEnvironment env) : Controller
{
    ...
    private static DateTime? NormalizeDateToUtc(DateTime? value){if(!value.HasValue) return null; return DateTime.SpecifyKind(value.Value.Date,DateTimeKind.Utc);}
