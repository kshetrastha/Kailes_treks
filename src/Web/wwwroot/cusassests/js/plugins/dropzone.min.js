(function() {
    ...
    l = function() {}, t = function() {
        ...
        return e.prototype.addEventListener = e.prototype.on, e.prototype.on = function(e, t) {
            ...
            var e, t, i, n, r;
            if (i = arguments[0], e = 2 <= arguments.length ? u.call(arguments, 1) : [], this._callbacks = this._callbacks || {}, t = this._callbacks[i])
        ...
        function n(e, t) {
            ...
            this.options.acceptedMimeTypes && (this.options.acceptedFiles = this.options.acceptedMimeTypes, delete this.options.acceptedMimeTypes), null != this.options.renameFilename && (this.options.renameFile = function(e) {
                return function(t) {
                    return e.options.renameFilename.call(e, t.name, t)
                }
            }(this)), this.options.method = this.options.method.toUpperCase(), (s = this.getExistingFallback()) && s.parentNode && s.parentNode.removeChild(s), !1 !== this.options.previewsContainer && (this.options.previewsContainer ? this.previewsContainer = n.getElement(this.options.previewsContainer, "previewsContainer") : this.previewsContainer = this.element), this.options.clickable && (!0 === this.options.clickable ? this.clickableElements = [this.element] : this.clickableElements = n.getElements(this.options.clickable, "clickable")), this.init()
        }
        var r, s;
        return p(n, e), n.prototype.Emitter = t, n.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], n.prototype.defaultOptions = {
            ...
            resize: function(e, t, i, n) {
                ...
                if (r = {
                        ...
                        srcWidth: e.width,
                        srcHeight: e.height
                    }, s = e.width / e.height, null == t && null == i ? (t = r.srcWidth, i = r.srcHeight) : null == t ? t = i * s : null == i && (i = t / s), t = Math.min(t, r.srcWidth), i = Math.min(i, r.srcHeight), o = t / i, r.srcWidth > t || r.srcHeight > i)
            ...
            addedfile: function(e) {
                ...
                if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                    for (e.previewElement = n.createElement(this.options.previewTemplate.trim()), e.previewTemplate = e.previewElement, this.previewsContainer.appendChild(e.previewElement), t = 0, s = (a = e.previewElement.querySelectorAll("[data-dz-name]")).length; t < s; t++) a[t].textContent = e.name;
                    ...
                    return function() {
                        return e.hiddenFileInput && e.hiddenFileInput.parentNode.removeChild(e.hiddenFileInput), e.hiddenFileInput = document.createElement("input"), e.hiddenFileInput.setAttribute("type", "file"), (null == e.options.maxFiles || e.options.maxFiles > 1) && e.hiddenFileInput.setAttribute("multiple", "multiple"), e.hiddenFileInput.className = "dz-hidden-input", null != e.options.acceptedFiles && e.hiddenFileInput.setAttribute("accept", e.options.acceptedFiles), null != e.options.capture && e.hiddenFileInput.setAttribute("capture", e.options.capture), e.hiddenFileInput.style.visibility = "hidden", e.hiddenFileInput.style.position = "absolute", e.hiddenFileInput.style.top = "0", e.hiddenFileInput.style.left = "0", e.hiddenFileInput.style.height = "0", e.hiddenFileInput.style.width = "0", document.querySelector(e.options.hiddenInputContainer).appendChild(e.hiddenFileInput), e.hiddenFileInput.addEventListener("change", function() {
                            ...
                            if ((i = e.hiddenFileInput.files).length)
                                for (n = 0, r = i.length; n < r; n++) t = i[n], e.addFile(t);
            ...
            for (t = function(e) {
                ...
                if (s = r[i], e = t(this.element.getElementsByTagName(s))) return e
            ...
            var t, i, n, r, s, o, l, a;
            if (s = 0, o = "b", e > 0) {
                for (i = n = 0, r = (a = ["tb", "gb", "mb", "kb", "b"]).length; n < r; i = ++n)
                    if (l = a[i], t = Math.pow(this.options.filesizeBase, 4 - i) / 10, e >= t) {
            ...
            C = s(this.options.method, e), N = s(this.options.url, e), O.open(C, N, !0), O.timeout = s(this.options.timeout, e), O.withCredentials = !!this.options.withCredentials, I = null, a = function(t) {
                ...
                return function(i) {
                    ...
                    if (null != i)
                        for (c = 100 * i.loaded / i.total, r = 0, l = e.length; r < l; r++)(o = e[r]).upload.progress = c, o.upload.total = i.total, o.upload.bytesSent = i.loaded;
                    else {
                ...
                return function(i) {
                    ...
                    if (e[0].status !== n.CANCELED && 4 === O.readyState) {
                        if ("arraybuffer" !== O.responseType && "blob" !== O.responseType && (I = O.responseText, O.getResponseHeader("content-type") && ~O.getResponseHeader("content-type").indexOf("application/json"))) try {
                            I = JSON.parse(I)
                        } catch (e) {
            ...
            if (this.options.uploadMultiple && this.emit("sendingmultiple", e, O, l), "FORM" === this.element.tagName)
                for (F = 0, E = (S = this.element.querySelectorAll("input, textarea, select, button")).length; F < E; F++)
                    if (h = S[F], m = h.getAttribute("name"), f = h.getAttribute("type"), "SELECT" === h.tagName && h.hasAttribute("multiple"))
                        for (k = 0, z = (M = h.options).length; k < z; k++)(L = M[k]).selected && l.append(m, L.value);
                    else(!f || "checkbox" !== (_ = f.toLowerCase()) && "radio" !== _ || h.checked) && l.append(m, h.value);
    ...
    }(t)).version = "5.1.1", e.options = {}, e.optionsForElement = function(t) {
        ...
        if (t = !0, window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
            if ("classList" in document.createElement("a"))
                for (i = 0, n = (r = e.blacklistedBrowsers).length; i < n; i++) r[i].test(navigator.userAgent) && (t = !1);
            else t = !1;
        else t = !1;
        return t
        ...
        var i, n, r, s, o;
        if (!t) return !0;
        for (t = t.split(","), i = (s = e.type).replace(/\/.*$/, ""), n = 0, r = t.length; n < r; n++)
        ...
        return e.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e.encode64 = function(e) {
            ...
            for (u = "", t = void 0, i = void 0, n = "", r = void 0, s = void 0, o = void 0, l = "", a = 0;;)
                if (t = e[a++], i = e[a++], n = e[a++], r = t >> 2, s = (3 & t) << 4 | i >> 4, o = (15 & i) << 2 | n >> 6, l = 63 & n, isNaN(i) ? o = l = 64 : isNaN(n) && (l = 64), u = u + this.KEY_STR.charAt(r) + this.KEY_STR.charAt(s) + this.KEY_STR.charAt(o) + this.KEY_STR.charAt(l), t = i = n = "", r = s = o = l = "", !(a < e.length)) break;
            return u
            ...
            for ("", i = void 0, n = void 0, r = "", s = void 0, o = void 0, l = void 0, a = "", u = 0, t = [], /[^A-Za-z0-9\+\/\=]/g.exec(e) && console.warning("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."), e = e.replace(/[^A-Za-z0-9\+\/\=]/g, "");;)
                if (s = this.KEY_STR.indexOf(e.charAt(u++)), o = this.KEY_STR.indexOf(e.charAt(u++)), l = this.KEY_STR.indexOf(e.charAt(u++)), a = this.KEY_STR.indexOf(e.charAt(u++)), i = s << 2 | o >> 4, n = (15 & o) << 4 | l >> 2, r = (3 & l) << 6 | a, t.push(i), 64 !== l && t.push(n), 64 !== a && t.push(r), i = n = r = "", s = o = l = a = "", !(u < e.length)) break;
            return t
        }, e
    }(), r = function(e, t) {
